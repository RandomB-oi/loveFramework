return function()
	...
	Soul1.Position = UDim2.new(0, 236.33253316048, 0, 369.26452)
	...
	Frame9.Name = "HealthBar"
	Frame9.Color = Color.new(1, 1, 0, 1)
	Frame9.Size = UDim2.new(1, 0, 1, 0)
	Frame9.Position = UDim2.new(0, 0, 0, 0)
	Frame9:SetParent(Frame8)
	Frame8.Name = "HealthBarBackdrop"
	Frame8.Color = Color.new(1, 0, 0, 1)
	Frame8.Size = UDim2.new(1, -200, 1, 0)
	Frame8.Position = UDim2.new(0, 50, 0, 0)
	Frame8:SetParent(Frame7)
	...
	TextLabel2:SetParent(Frame7)
	Frame7.AnchorPoint = Vector.new(0.5, 1)
	Frame7.Name = "HealthBarPanel"
	Frame7.Color = Color.new(1, 1, 1, 0)
	Frame7.Size = UDim2.new(0, 340, 0, 50)
