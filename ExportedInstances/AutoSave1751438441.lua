return function()
	...
	Frame5.Size = UDim2.new(0, 2, 1, 0)
	Frame5:SetAttribute("AxisLock", Vector.new(1, 0))
	...
	Soul1.Name = "Soul"
	Soul1.ZIndex = 2
	Soul1.Position = UDim2.new(0, 198.1019079709, 0, 288.1019079709)
	...
	TextLabel3.Text = "HP"
	TextLabel3.Name = "HPLabel"
	TextLabel3.Position = UDim2.new(0, 0, 0, 0)
	TextLabel3.Size = UDim2.new(0, 50, 1, 0)
