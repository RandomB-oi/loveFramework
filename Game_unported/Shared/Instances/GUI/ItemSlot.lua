...
module.new = function(...)
	...
	-- self.SlotFrame.Image = "Game/Client/Assets/GUI/ItemSlot.png"
	-- self.SlotFrame.Size = UDim2.new(1, 0, 1, 0)
	-- self.SlotFrame.Parent = self
	...
	self.RenderFrame.Parent = self.SlotFrame
	...
	self.AmountLabel.Parent = self.SlotFrame
