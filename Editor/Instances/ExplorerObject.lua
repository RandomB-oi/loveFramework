...
module.new = function(object, depth)
	...
	self.Title.Size = UDim2.new(1, -CellHeight, 0, CellHeight)
	self.Title.Position = UDim2.new(0, CellHeight, 0, 0)
	...
	self.ChildrenList.Position = UDim2.new(0, self.Depth, 0, CellHeight)
